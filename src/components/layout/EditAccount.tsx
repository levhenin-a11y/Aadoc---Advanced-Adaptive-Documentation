    ...
    <div className="max-w-2xl mx-auto w-full">
      <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6 space-y-8">
        ...
        <div className="space-y-2">
          <Label htmlFor="login" className="text-base font-semibold text-card-foreground">
            Login
          </Label>
          <Input
            id="login"
        ...
        {/* Entité hiérarchique */}
        <div className="space-y-2">
          <Label htmlFor="entity" className="text-base font-semibold text-card-foreground">
            Entité hiérarchique
          </Label>
          <Input
            id="entity"
        ...
        {/* Visibilité */}
        <div className="space-y-2">
          <Label htmlFor="visibility" className="text-base font-semibold text-card-foreground">
            Visibilité
          </Label>
          <Input
            id="visibility"
