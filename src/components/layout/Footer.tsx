...
const Footer = () => {
  ...
  return <footer className="text-footer-foreground py-4 px-6 bg-primary-foreground" role="contentinfo">
      <nav aria-label="Liens légaux et informations" className="flex flex-wrap items-center justify-center gap-2 text-sm">
