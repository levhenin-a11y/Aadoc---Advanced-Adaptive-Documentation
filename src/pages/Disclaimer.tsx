      ...
      <div className="title-container">
        ...
        <Card className="bg-card/80 backdrop-blur space-y-0">
          ...
          <CardContent className="prose prose-sm max-w-none space-y-4 text-card-foreground">
            <section>
              <h3 className="section-subtitle">Éditeur</h3>
              <p>
            ...
            <section>
              <h3 className="section-subtitle">Propriété intellectuelle</h3>
              <p>
            ...
            <section>
              <h3 className="section-subtitle">Protection des données</h3>
              <p>
            ...
            <section>
              <h3 className="section-subtitle">Responsabilité</h3>
              <p>
            ...
            <section>
              <h3 className="section-subtitle">Cookies</h3>
              <p>
